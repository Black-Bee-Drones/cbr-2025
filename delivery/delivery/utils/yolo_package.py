...
class YOLOPackageDetector:
    ...
    def detect(
        self, image: np.ndarray, save_image: bool = True, timestamp: Optional[int] = None, desired_class: int = 1
    ) -> List[Dict[str, any]]:
        """
        ...
        Args:
            ...
            desired_class: Class ID to filter detections (default 1 for package)
    ...
    def get_best_detection(
        self, detections: List[Dict[str, any]], desired_class: int = 1
