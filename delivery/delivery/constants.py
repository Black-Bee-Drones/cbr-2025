...
TARGET_DOWN_ALTITUDE = 0.5  # Distancia de descida para para centralizar

MIN_CENTERING_ALTITUDE = 1.2  # final altitude above figure for landing
...
POSITION_CONTROLLER_TOLERANCE_YAW = 0.05  # Rad, Yaw tolerance for considering the PID at the target
CENTERING_P_GAIN = 0.002                                        # I guess it's depreciated!

# Centering and alignment
ALIGN_X_PROPORTION = 0.7

# Detections lost to restart detection
DETECTIONS_LOST_TOLERANCE = 5
