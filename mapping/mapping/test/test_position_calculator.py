#!/usr/bin/env python3
"""
Test script for DetectionPositionCalculator

Tests position calculation and duplicate filtering logic with synthetic data.
"""
...
sys.path.insert(0, '/home/jetson/ros2_ws/src/cbr-2025/mapping')
...
def test_all_duplicates():
    ...
    # Visited bases covering the area
    visited_bases = [
        {"x": 4.8, "y": 5.1, "z": 0.0},
        {"x": 5.3, "y": 4.9, "z": 0.0},
    ]
    
    # Detections near visited bases
    detections = [
